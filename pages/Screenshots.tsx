      ...
      <div className="bg-brand-900 py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-brand-100 max-w-2xl mx-auto">
            Try out GxLMS yourself or schedule a personalized walkthrough with our team.
          </p>
          <div className="mt-8 flex items-center justify-center gap-x-6">
            <a              href="https://wa.me/233247439400?text=Hi%2C%20I%20would%20like%20to%20request%20login%20details%20for%20the%20GxLMS%20demo."
              target="_blank"
            ...
            <a              href="https://loanapstorage.blob.core.windows.net/loansapp/Publish.html"
              target="_blank"
              rel="noopener noreferrer"
